...
static std::string test_mult_int8(void)
{
	std::stringstream ss;
...
static std::string test_mult_int16(void)
{
	std::stringstream ss;
...
static std::string test_mult_int32(void)
{
	std::stringstream ss;
...
static std::string test_mult_float(void)
{
	std::stringstream ss;
...
static std::string test_mult_double(void)
{
	std::stringstream ss;
...
static void test_mult(void)
{
	...
	std::cout << "Int8 ->" << test_mult_int8() << std::endl;
	std::cout << "Int16 ->" << test_mult_int16() << std::endl;
	std::cout << "Int32 ->" << test_mult_int32() << std::endl;
	std::cout << "Float ->" << test_mult_float() << std::endl;
	std::cout << "Double ->" << test_mult_double() << std::endl;
}
